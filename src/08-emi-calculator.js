...
export function calculateEMI(principal, monthlyRate, emi) {
  ...
  while (remaining > 0) {
    ...
    if (remaining < emi) {
      ...
      finalData.months++;
      finalData.totalPaid += emi;
    }
  }
  finalData.totalInterest = Math.round(((finalData.totalPaid - principal) * 100)) / 100;
